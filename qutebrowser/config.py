...
# Allow websites to register protocol handlers (don't ask permission)
...
# config.bind('u', 'scroll-px 0 -80')

# Bindings for closing and focusing tabs
...
# Status and tabs appearance
c.statusbar.show = 'always'
c.tabs.position = 'left'
c.tabs.width = '12%'
c.tabs.last_close = 'startpage'
c.tabs.favicons.scale = 1.25
c.tabs.padding = {'top': 10, 'bottom': 10, 'left': 10, 'right': 5}
...
c.colors.statusbar.normal.bg = '#00040a'
...
c.colors.tabs.bar.bg = "rgba(0,4,10, 0.8)"
